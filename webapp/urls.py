...
from webapp.views import PatientViewSet, RecordViewSet, CityViewSet, JobViewSet, PatientRecordViewSet, UserViewSet, DataViewSet, PatientDataViewSet, DiagnosisViewSe
